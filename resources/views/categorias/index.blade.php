        ...
        <form :action="edit ? `/categorias/${edit.id}` : '{{ route('categorias.store') }}'" method="POST" class="space-y-3">
            ...
            <div class="grid grid-cols-2 gap-3">
                <div>
                    ...
                    <input type="color" name="color" :value="edit?.color || '#10b981'" class="w-full h-10 border border-slate-300 rounded-lg">
                </div>
                <div>
                    <label class="block text-sm font-semibold mb-1">Ícono</label>
                    <select name="icono" class="w-full px-3 py-2 border border-slate-300 rounded-lg">
