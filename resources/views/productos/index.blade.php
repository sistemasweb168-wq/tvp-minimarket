...
<div class="bg-slate-900 border border-slate-800 rounded-2xl shadow-md p-4 sm:p-5 mb-4 sm:mb-5">
    <div class="flex flex-col md:flex-row gap-3 justify-between items-stretch md:items-center">
        ...
        <div class="flex gap-2 w-full sm:w-auto">
            <button onclick="document.getElementById('modal-importar').classList.remove('hidden')" class="bg-blue-600 text-white px-4 py-2.5 rounded-xl font-bold hover:bg-blue-700 hover:shadow-lg transition flex items-center justify-center gap-2 text-sm shadow-sm flex-1 sm:flex-none">
                <i class="fas fa-file-excel"></i><span>Excel</span>
            </button>
            <a href="{{ route('productos.create') }}" class="gradient-primary text-white px-4 py-2.5 rounded-xl font-bold hover:shadow-lg transition flex items-center justify-center gap-2 text-sm shadow-sm flex-1 sm:flex-none">
