        ...
        <div class="bg-slate-900 border border-slate-800 rounded-2xl shadow-md p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="codigo" value="{{ old('codigo', $codigo) }}" required class="w-full px-3 py-2.5 border border-slate-600 rounded-lg focus:outline-none focus:border-amber-500">
                </div>
                <div>
                    <label class="block text-sm font-semibold text-slate-200 mb-1">Código de barras</label>
                    <input type="text" name="codigo_barras" value="{{ old('codigo_barras') }}" class="w-full px-3 py-2.5 border border-slate-600 rounded-lg">
                </div>
                <div class="md:col-span-2">
                    <label class="block text-sm font-semibold text-slate-200 mb-1">Nombre <span class="text-red-500">*</span></label>
                    <input type="text" name="nombre" value="{{ old('nombre') }}" required class="w-full px-3 py-2.5 border border-slate-600 rounded-lg">
                </div>
                <div class="md:col-span-2">
...
<div>
                ...
                <div>
                    ...
                    <input type="text" name="ubicacion" placeholder="Ej: Pasillo 3 Estante 2" class="w-full px-3 py-2.5 border border-slate-600 rounded-lg">
                </div>
            </div>
        </div>
        ...
        <div class="bg-slate-900 border border-slate-800 rounded-2xl shadow-md p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    <label class="block text-sm font-semibold text-slate-200 mb-1">Precio de Compra <span class="text-red-500">*</span></label>
                    <input type="number" step="0.01" name="precio_compra" value="0" required class="w-full px-3 py-2.5 border border-slate-600 rounded-lg">
                </div>
                <div>
                    <label class="block text-sm font-semibold text-slate-200 mb-1">Precio de Venta <span class="text-red-500">*</span></label>
                    <input type="number" step="0.01" name="precio_venta" value="0" required class="w-full px-3 py-2.5 border border-slate-600 rounded-lg">
                </div>
                <div>
                    <label class="block text-sm font-semibold text-slate-200 mb-1">Precio Mayoreo</label>
                    <input type="number" step="0.01" name="precio_mayoreo" value="0" class="w-full px-3 py-2.5 border border-slate-600 rounded-lg">
                </div>
                <div>
                    <label class="block text-sm font-semibold text-slate-200 mb-1">Cantidad Mínima Mayoreo</label>
                    <input type="number" name="cantidad_mayoreo" value="0" class="w-full px-3 py-2.5 border border-slate-600 rounded-lg">
                </div>
            </div>
        </div>
        ...
        <div class="bg-slate-900 border border-slate-800 rounded-2xl shadow-md p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                    ...
                    <input type="number" step="0.001" name="stock" value="0" class="w-full px-3 py-2.5 border border-slate-600 rounded-lg">
                </div>
                <div>
                    <label class="block text-sm font-semibold text-slate-200 mb-1">Stock Mínimo</label>
                    <input type="number" step="0.001" name="stock_minimo" value="0" required class="w-full px-3 py-2.5 border border-slate-600 rounded-lg">
                </div>
                <div>
                    <label class="block text-sm font-semibold text-slate-200 mb-1">Stock Máximo</label>
                    <input type="number" step="0.001" name="stock_maximo" value="0" class="w-full px-3 py-2.5 border border-slate-600 rounded-lg">
                </div>
                <div>
                    <label class="block text-sm font-semibold text-slate-200 mb-1">Lote</label>
                    <input type="text" name="lote" class="w-full px-3 py-2.5 border border-slate-600 rounded-lg">
                </div>
                <div>
                    <label class="block text-sm font-semibold text-slate-200 mb-1">Fecha Vencimiento</label>
                    <input type="date" name="fecha_vencimiento" class="w-full px-3 py-2.5 border border-slate-600 rounded-lg">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="space-y-5">
        <div class="bg-slate-900 border border-slate-800 rounded-2xl shadow-md p-6">
            ...
            <input type="file" name="imagen" accept="image/*" class="block w-full text-sm text-slate-400 file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:bg-emerald-50 file:text-emerald-700 hover:file:bg-emerald-100">
        </div>

        <div class="bg-slate-900 border border-slate-800 rounded-2xl shadow-md p-6">
            <h3 class="font-bold text-slate-100 mb-4"><i class="fas fa-cog text-emerald-500 mr-2"></i>Opciones</h3>
            ...
            <label class="flex items-center gap-3 cursor-pointer">
                ...
                <span class="text-sm text-slate-200">Producto destacado (POS)</span>
            </label>
        </div>
