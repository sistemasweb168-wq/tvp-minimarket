...
<form method="POST" action="{{ route('productos.update', $producto->id) }}" enctype="multipart/form-data" class="grid grid-cols-1 lg:grid-cols-3 gap-5">
    ...
    <div class="lg:col-span-2 space-y-5">
        ...
        <div class="bg-white rounded-2xl shadow-md p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    <label class="block text-sm font-semibold text-slate-700 mb-1">Precio de Compra</label>
                ...
                <div>
                    <label class="block text-sm font-semibold text-slate-700 mb-1">Precio de Venta</label>
