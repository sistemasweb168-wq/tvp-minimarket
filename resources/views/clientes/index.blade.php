...
<div class="bg-white rounded-2xl shadow-md overflow-hidden">
        ...
        @forelse($clientes as $c)
            <div class="p-3.5 flex items-start gap-3 hover:bg-slate-50 transition">
                ...
                <div class="flex-1 min-w-0">
                    <h4 class="font-extrabold text-slate-800 text-xs sm:text-sm leading-snug">{{ $c->nombre_completo }}</h4>
                    <div class="flex items-center gap-1.5 text-[11px] text-slate-500 my-0.5">
                    ...
                    <tr class="hover:bg-slate-50/80 transition">
                        <td class="py-3.5 px-4">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <p class="font-semibold text-slate-800 text-sm">{{ $c->nombre_completo }}</p>
                        ...
                        <td class="py-3.5 px-4 text-sm">
                            @if($c->telefono)<p class="text-xs text-slate-600"><i class="fas fa-phone text-xs text-slate-400 mr-1"></i>{{ $c->telefono }}</p>@endif
                        ...
                        <td class="py-3.5 px-4 text-right text-sm whitespace-nowrap">
                            <p class="font-bold text-slate-800">{{ $moneda }}{{ number_format($c->credito_disponible, 2) }}</p>
    ...
    <div class="p-3 sm:p-4 border-t border-slate-100">{{ $clientes->withQueryString()->links() }}</div>
</div>
@endsection
